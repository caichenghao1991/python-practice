...
class Review:
    ...
    --Binary and nary 
    bin(149)  # 0b10010101 string  binary    oct(149)  #0o225  8     hex(149) # 0x95 16    
    int("0b11",2)   # back to decimal
    ...
    sys.argv   # argument parsed for running the module
        ...
        parser.add_argument('-n','--name',default="Chenghao", help='your name')
    ...
    this hexadecimal is used to compare with the correct hexadecimal in database to validate same
